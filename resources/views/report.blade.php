...
<head>
    ...
    <title>Customer - SDN 1 Sumbersewu</title>
    <style>
        #emp {
...
<table>
    {{-- <tr>
        ...
        <td> --}}
            <h2 style="text-align: center">SDN 1 Sumbersewu</h2>
            <h3 style="text-align: center"><b>Kab Banyuwangi<b></h3>
            <h4 style="text-align: center"><i>Jln.PB Sudirman No. 98 Desa Sumbersewu Kec. Muncar<i></h4>
        </td>
    </tr>
    <tr>
        <td colspan="10">
...
<body>
    <div class="card-header">
        ...
        <p style="text-align: justify">Buku tamu <strong>SDN 1 Sumbersewu</strong> merupakan buku yang berisi daftar
            pelanggan yang bertujuan dalam pemenuhan kebutuhan data.
            Buku tamu ini bisa menjadi patokan dalam evaluasi SDN 1 Sumbersewu dalam melayani masyarakat. Berikut ini
